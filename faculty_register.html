...
%>
	...
	try
	{
		...
		// create a SQL statement
		Statement stmt = con.createStatement();
		String sql = "insert into faculty (name, username, email_id, password, degree, course, year, subject) values('" + name + "','" + username + "','" + email + "',('" + password + "'),'" + degree + "','" + course + "','" + year + "','" + subject + "')"; 
